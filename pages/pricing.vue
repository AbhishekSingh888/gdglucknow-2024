<template>
  <h1 class="text-center">Choose Your Dev Fest 2024 Pass</h1>
  <p class="text-center">Grab your pass early to enjoy discounted rates and be part of the biggest developer gathering
    of the year!</p>
        ...
        <div class="shadow-wrapper">
          <v-card class="pricing-card early-bird-card flex-column" outlined>
            ...
            <v-card-text class="flex-grow-1">
              ...
              <p>Get full access to all Dev Fest 2024 sessions, workshops, and networking opportunities at a special
                early rate!</p>
            </v-card-text>
            <v-card-actions>
      ...
      <v-col cols="12" md="4" class="d-flex">
        <div class="shadow-wrapper">
          <v-card class="pricing-card standard-card flex-column" outlined>
            ...
            <v-card-text class="flex-grow-1">
              <p class="subtext">Available Now</p>
              <div class="divider"></div>
              <p>Access all sessions, workshops, networking events! Join us to connect and learn from industry leaders.
              </p>
            </v-card-text>
            <v-card-actions>
        ...
        <div class="shadow-wrapper">
          <v-card class="pricing-card last-minute-card flex-column" outlined>
            ...
            <v-card-text class="flex-grow-1">
              ...
              <div class="divider"></div>
              <p>Get the same great access to all events, sessions, and workshops! Don’t miss out on the biggest
...
export default {
  ...
  methods: {
    openLink() {
      window.open("https://www.commudle.com/fill-form/2969", "_blank");
    },
    openLastMinLink() {
      window.open("https://www.commudle.com/fill-form/2970", "_blank");
    }
  }
};
</script>
...
.shadow-wrapper:hover {
  ...
  box-shadow: -10px 10px 0px rgba(0, 0, 0, 1), -10px -10px 20px rgba(255, 255, 255, 0);
}
